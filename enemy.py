        ...
        if self.site == 'chaos':
            ...
            if gs[0][0] == gs[5][5] == 0:
                ...
                if diagonal.count('x') == 3 and diagonal.count(0) == 1:
                    self.move_execution((0, 0), 'o')
                if diagonal.count('o') == 3 and diagonal.count(0) == 1:
                    self.move_execution((0, 0), 'x')
            # case 2: 05-50 open 3
            if gs[0][5] == gs[5][0] == 0:
                diagonal = [gs[1][4], gs[2][3], gs[3][2], gs[4][1]]
                if diagonal.count('x') == 3 and diagonal.count(0) == 1:
                    self.move_execution((0, 5), 'o')
                if diagonal.count('o') == 3 and diagonal.count(0) == 1:
                    self.move_execution((0, 5), 'x')
            # case 3: 00-55 open 4
            ...
            if gs[1][4] == gs[2][3] == gs[3][2] == gs[4][1]:
                if gs[1][4] == 'x':
                    if gs[0][5] == 0:
                        ...
                        self.move_execution((5, 0), 'o')
                elif gs[1][4] == 'o':
                    if gs[0][5] == 0:
                        self.move_execution((0, 5), 'x')
                    else:
                        self.move_execution((5, 0), 'x')
            ...
            self.move_execution((column, row), token)
